    ...
    <div>
      ...
      <Column className="relative text-center">
        <h1 className="text-[28px] text-white pt-[30px] px-[62px]"> با هزاران  آموزش‌  کاربردی، همین امروز شروع کن،
          ...
          <Row  className="mt-[30px] w-[calc(100%-52px)] bg-white p-[8px] gap-[14px] h-[71px] mx-[26px] " >
            <input type="text" className="bg-[#928C8C] flex-1 h-full rounded-[14px]" />
            <div className="bg-[#1D4ED8] w-[56px] h-full rounded-[14px]"></div>
            </Row>
        <Image
          aria-hidden
