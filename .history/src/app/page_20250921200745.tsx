    ...
    <div>
      ...
      <Column className="relative text-center">
        ...
        <Row className="flex-wrap gap-x-[11px] gap-y-[15px] mt-[15px] justify-center ">
          <li className="rounded-[12px] text-[16px] px-[20px] py-[8px] bg-[#8AAAF0] text-white"> ریاضیات پایه </div>
          <li className="rounded-[12px] text-[16px] px-[20px] py-[8px] bg-[#8AAAF0] text-white"> ریاضیات پایه </div>
          <li className="rounded-[12px] text-[16px] px-[20px] py-[8px] bg-[#8AAAF0] text-white"> ریاضیات پایه </div>
          <li className="rounded-[12px] text-[16px] px-[20px] py-[8px] bg-[#8AAAF0] text-white"> ریاضیات پایه </div>
          <li className="rounded-[12px] text-[16px] px-[20px] py-[8px] bg-[#8AAAF0] text-white"> ریاضیات پایه </div>
      ...
      <Column className="gap-[17px] text-center ">
        <Column>
          <li className="text-[32px]">+ 1, 789 335</li>
        </Column>
      </Column>
    </div>
  );
