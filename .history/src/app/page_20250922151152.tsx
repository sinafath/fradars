    ...
    <div>
      ...
      <Column className="relative text-center">
        ...
        <Row className="mt-[30px] w-[calc(100%-52px)] bg-white p-[8px] gap-[14px] h-[71px] mx-[26px] rounded-[10px]" >
          <input type="text" className="bg-[#F5F5F5] flex-1 h-full text-b rounded-[8px] px-[24px] " placeholder="چی میخوای یاد بگیری؟" />
      ...
      <Row justify="between" className="mt-[44px] mb-[26px] px-[24px]">
