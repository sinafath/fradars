  ...
  return (
    <div>
      ...
      <Row className="m-[30px]">
       <div className="me-[37px] text-[#A7A7A7] text-[24px] pb-[22px] border-b border-dashed border-b-gray-500">همه آموزش ها</div>
       <div className="me-[38px] ms-[37px] text-[#6489F2]" > برنامه نویسی</div>
