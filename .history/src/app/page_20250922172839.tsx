...
export default function Home() {
  return (
    <div>
      ...
      <Row className="m-[30px]">
        <div className="pe-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b border-solid border-b-gray-[#C9C9C9]">همه آموزش ها</div>
        <div className="pe-[18px] ps-[18px] text-[#6489F2] text-[#A7A7A7] text-[24px] pb-[22px] border-b border-solid border-b-gray-[#C9C9C9]"  > برنامه نویسی</div>
        <div className="pe-[18px] ps-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b border-solid border-b-gray-[#C9C9C9]">آمار و دادکاوی</div>
        <div className="pe-[18px] ps-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b border-solid border-b-gray-[#C9C9C9]">پایتون</div>
        <div className="pe-[18px] ps-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b border-solid border-b-gray-[#C9C9C9]">زبان</div>
      </Row>
    </div>
  );
}
