  ...
  return (
    <div>
      ...
      <Row className="m-t-[30px] overflow-y-auto ms-[24px]">
        < className="pe-[18px] flex-shrink-0   text-[#A7A7A7] text-[24px] pb-[22px] border-b border-solid border-b-[#C9C9C9]">همه آموزش ها</div>
        < className="pe-[18px] flex-shrink-0 ps-[18px] text-[#6489F2]  text-[24px] pb-[22px] border-b-[4px] border-solid border-b-[#6489F2]"  > برنامه نویسی</div>
        < className="pe-[18px] flex-shrink-0 ps-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b  border-b-solid border-b-[#C9C9C9]">آمار و دادکاوی</div>
        < className="pe-[18px] flex-shrink-0 ps-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b border-b-solid border-b-[#C9C9C9]">پایتون</div>
        < className="pe-[18px] flex-shrink-0 ps-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b border-b-solid border-b-[#C9C9C9]">زبان</div>
      </Row>
    </div>
  );
}
