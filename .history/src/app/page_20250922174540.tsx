  ...
  return (
    <div>
      ...
      <Row className="m-t-[30px] overflow-y-auto ms-[24px]">
        <div className="pe-[18px] flex-shrink-0   text-[#A7A7A7] text-[24px] pb-[22px] border-b-[1px]  border-solid border-b-[#C9C9C9]">همه آموزش ها</div>
        ...
        <div className="pe-[18px] flex-shrink-0 ps-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b-[1px]  border-b-solid border-b-[#C9C9C9]">آمار و دادکاوی</div>
        <div className="pe-[18px] flex-shrink-0 ps-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b-[1px] border-b-solid border-b-[#C9C9C9]">پایتون</div>
        <div className="pe-[18px] flex-shrink-0 ps-[18px] text-[#A7A7A7] text-[24px] pb-[22px] border-b-[1px] border-b-solid border-b-[#C9C9C9]">زبان</div>
      </Row>
      <Row className="m-t-[13px] overflow-y-auto ms-[24px]">
