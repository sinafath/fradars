...
export default function Home() {
  return (
    <div>
      ...
      <Row className=" overflow-y-auto ms-[24px]">
      ...
      <Row className="mt-[12px] gap-[12px] overflow-y-auto ms-[24px]">
        <Column className="rounded-[28px] w-[108px] h-[56px]  py-[10px] flex-shrink-0 gap-[1px] bg-[#263A73] text-center text-white text-[18px]">
        ...
        <Column className="rounded-[28px] w-[108px] h-[56px]  py-[10px] flex-shrink-0 gap-[1px] bg-[#263A73] text-center text-white text-[18px]">
          <div className="">Html</div>
          <div>34+ دوره</div>
        </Column>        <Column className="rounded-[28px] w-[108px] h-[56px]  py-[10px] flex-shrink-0 gap-[1px] bg-[#263A73] text-center text-white text-[18px]">
          <div className="">Html</div>
          <div>34+ دوره</div>
        </Column>        <Column className="rounded-[28px] w-[108px] h-[56px]  py-[10px] flex-shrink-0 gap-[1px] bg-[#263A73] text-center text-white text-[18px]">
          <div className="">Html</div>
