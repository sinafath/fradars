...
export default function Home() {
  return (
    <div>
      ...
      <Card />
      <Center className="relative w-full h-[160px] px-[20px] mt-[35px]">
        <Row className=" gap-[28px]">
          <p className="text-white">  همین حالا یه دوره رو انتخاب کن و مسیر رو شروع کن</p>
            <button className="bg-white border-none ">شروع یادگیری</button>
        </Row>
        <Image
          aria-hidden
          className="absolute left-0"
