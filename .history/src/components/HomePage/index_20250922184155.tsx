...
function Card({ }: CardProps) {
    return (
        <Row className="mt-[22px] gap-[20px] ms-[24px] overflow-y-auto no-scrollbar">
            <Column className={'w-[397px] flex-shrink-0    py-[18px] px-[20px] pb-[53px] rounded-[20px] border-[1px] border-solid border-[#D4D4D4]'}>
                <Image
                    aria-hidden
                    src="/5.png"
                    alt="File icon"
                ...
                <Row justify="between" className="mt-[24px] w-full">
                    <Row className="text-[20px]">
                        <img src="/8.svg" />
                        <div className=" ms-[2px]">4.7
                            <span className="text-[#A4A4A4] ms-[2px]">(52,300 رای)</span>
                        </div>
                    </Row>
                    <Row className="text-[20px]">
                        <div className=" ms-[2px]">26.000.000
</div>
                            <span className="text-[#A4A4A4] ms-[2px] text-[10px]">تومان</span>
